                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-gray-950 py-6 shadow-xl">
                      <div className="px-4 sm:px-6">
                        <div className="flex items-start justify-end">
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              type="button"
                              className="rounded-md bg-rose-600 text-gray-950 hover:text-white focus:outline-none "
                              onClick={onClose}
                            >
                      ...
                      <div className="relative mt-6 flex-1 px-4 sm:px-6">
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex gap-10 my-8">
                            <div onClick={() => setConfirmOpen(true)} className="flex flex-col gap-3 items-center cursor-pointer hover:opacity-75">
                              ...
                              <div className="text-sm font-light text-rose-500">
                                Delete
                              </div>
                            </div>
                          </div>
                        ...
                        <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                          ...
                          {!data.isGroup && (
                            <>
                              <hr className='border-t2 border-cyan-400'/>
                              <div>
                                <dt 
                                  className="
                                    text-sm 
